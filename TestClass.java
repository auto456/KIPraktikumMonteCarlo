...
//		RegulatedMotor morgenstern = new EV3MediumRegulatedMotor(MotorPort.B);
		
		//Wheels and Chassis 2 Wheels
		Wheel wheel1 = WheeledChassis.modelWheel(Motor.A, 75).offset(-115);
		Wheel wheel2 = WheeledChassis.modelWheel(Motor.D, 75).offset(115);
